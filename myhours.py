...
def startTrackWithDescription2(jira, description, epic_link) :
    ...
    tools.waitLoadingPageByXPATH2(dealy_properties, '//*[@id="bulk-tags-autocomplete"]')
    switchToWeekTrackBtn = tools.driver.find_element(By.XPATH, '//*[@id="bulk-tags-autocomplete"]')
    switchToWeekTrackBtn.click()
    time.sleep(2)
    switchToWeekTrackBtn.send_keys("JIRA")
    switchToWeekTrackBtn.send_keys(Keys.ENTER)
