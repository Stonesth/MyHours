...
def startTrackWithDescription2(jira, description, epic_link) :
    ...
    tools.waitLoadingPageByXPATH2(dealy_properties, '//*[@id="bulk-task-name"]')
    ...
    tools.waitLoadingPageByXPATH2(dealy_properties, '//*[@id="bulk-notes"]')
    ...
    tools.waitLoadingPageByXPATH2(dealy_properties, '//*[@id="bulk-tags"]')
